...
class Video extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      seeking: false,
      renderError: false,
      fullscreenWithNoSideEffects: false
    };
  ...
  onError(msg) {
    ...
    this.setState({ renderError: true }, () => {
      ...
      switch (true) {
        ...
        default:
          // do nothing.
          // this alert is annoying and useless
  ...
  toggleFS = () => {
    this.setState(
      {
        fullscreenWithNoSideEffects: !this.state.fullscreenWithNoSideEffects
      },
      () => {
        console.log(`Within video`);
        this.props.onVideoPress(this.state.fullscreenWithNoSideEffects);
        //   Orientation.getOrientation((e, orientation) => {
        //     if (this.state.fullScreen) {
        //       const initialOrient = Orientation.getInitialOrientation();
